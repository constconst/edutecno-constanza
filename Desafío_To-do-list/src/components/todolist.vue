<template>
    <div class="container">
        ...
        <div>
            ...
            <input v-model="task" type="text" placerholder="Ingresar texto aquí" class="form-control">
            <!-- otro tipo de v-on:click -->
            <button @click="submitTask" class="btn waves-effect waves-light" type="submit" name="action">Anotar
